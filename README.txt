...
A página estatisticas.html consulta (removido nesta versão). Essa função lê os dados diretamente da API oficial do Vercel Web Analytics.
...
--------------------------
A página estatisticas.html não depende mais de token da Vercel, CounterAPI.dev ou função serverless.
O arquivo js/contador-acessos.js registra um page view nas páginas públicas.
O arquivo js/estatisticas.js consulta os totais em modo somente leitura e calcula visitantes únicos e páginas por visitante.
A página estatisticas.html não incrementa o contador.
O Vercel Web Analytics pode continuar habilitado separadamente no painel da Vercel.


ESTATÍSTICAS SIMPLIFICADAS - V2
--------------------------------
Esta versão usa js/contador-acessos-v2.js e js/estatisticas-v2.js.
Não requer token, workspace, função serverless, banco de dados ou variável de ambiente na Vercel.
