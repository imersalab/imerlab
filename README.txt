...
Interpretação:
- 404 ou página HTML: a função não está ativa. Publique na Vercel com a pasta api na raiz ou use `vercel dev` localmente.
- COUNTER_CONFIG_REQUIRED: faltam COUNTERAPI_WORKSPACE e/ou COUNTERAPI_TOKEN.
- 401/403 do CounterAPI: token inválido ou sem permissão.
- 404 do CounterAPI: confira o nome do workspace.
